...
def ensure_drvloop_memory(
    *,
    ...
    initial = (
        ...
        "\n"
        "### Major needed\n"
        "- Read the locked derivation spec and choose the next derivation step or route to test.\n"
        "- Keep proof obligations current so validator feedback can guide the next round.\n"
        "- Follow `fermilink-drvloop/workflow_state.json`; publication-depth runs require route population, pathway development, synthesis, review, numerical checks, and final consistency before the controller starts any final publication-export sweep.\n"
        "\n"
        "### Major conclusions\n"
